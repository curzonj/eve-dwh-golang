...
func easyjson84a04251DecodeGithubComCurzonjGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsActiveTotal1List) {
...
func easyjson84a04251EncodeGithubComCurzonjGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsActiveTotal1List) {
...
func (v GetFwLeaderboardsActiveTotal1List) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson84a04251EncodeGithubComCurzonjGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsActiveTotal1List) UnmarshalJSON(data []byte) error {
	...
	easyjson84a04251DecodeGithubComCurzonjGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsActiveTotal1List) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson84a04251DecodeGithubComCurzonjGoesiEsi(l, v)
}
func easyjson84a04251DecodeGithubComCurzonjGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsActiveTotal1) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson84a04251EncodeGithubComCurzonjGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsActiveTotal1) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsActiveTotal1) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson84a04251EncodeGithubComCurzonjGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsActiveTotal1) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson84a04251DecodeGithubComCurzonjGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsActiveTotal1) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson84a04251DecodeGithubComCurzonjGoesiEsi1(l, v)
}
