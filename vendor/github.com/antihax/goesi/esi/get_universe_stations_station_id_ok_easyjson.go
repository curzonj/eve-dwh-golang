...
func easyjsonBde2b678DecodeGithubComCurzonjGoesiEsi(in *jlexer.Lexer, out *GetUniverseStationsStationIdOkList) {
...
func easyjsonBde2b678EncodeGithubComCurzonjGoesiEsi(out *jwriter.Writer, in GetUniverseStationsStationIdOkList) {
...
func (v GetUniverseStationsStationIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonBde2b678EncodeGithubComCurzonjGoesiEsi(&w, v)
...
func (v *GetUniverseStationsStationIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonBde2b678DecodeGithubComCurzonjGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseStationsStationIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonBde2b678DecodeGithubComCurzonjGoesiEsi(l, v)
}
func easyjsonBde2b678DecodeGithubComCurzonjGoesiEsi1(in *jlexer.Lexer, out *GetUniverseStationsStationIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "position":
			easyjsonBde2b678DecodeGithubComCurzonjGoesiEsi2(in, &out.Position)
		case "race_id":
...
func easyjsonBde2b678EncodeGithubComCurzonjGoesiEsi1(out *jwriter.Writer, in GetUniverseStationsStationIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	...
	if true {
		...
		easyjsonBde2b678EncodeGithubComCurzonjGoesiEsi2(out, in.Position)
	}
	if in.RaceId != 0 {
		if !first {
			out.RawByte(',')
...
func (v GetUniverseStationsStationIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonBde2b678EncodeGithubComCurzonjGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseStationsStationIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonBde2b678DecodeGithubComCurzonjGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseStationsStationIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonBde2b678DecodeGithubComCurzonjGoesiEsi1(l, v)
}
func easyjsonBde2b678DecodeGithubComCurzonjGoesiEsi2(in *jlexer.Lexer, out *GetUniverseStationsStationIdPosition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBde2b678EncodeGithubComCurzonjGoesiEsi2(out *jwriter.Writer, in GetUniverseStationsStationIdPosition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.X != 0 {
